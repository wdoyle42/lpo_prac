...
stata-se -b -q do more_dataset_manipulation.do
...
> [Bureau of Economic Analysis](http://www.bea.gov/regional/downloadzip.cfm). Reshape the dataset and then create
> a plot using the `xtline` command. You're looking for the "Annual state personal income and employment" under state personal income accounts.
