...
eststo order1: svy: reg `y' i.order_plan  female
...
eststo order2: svy: reg `y' ib(3).order_plan  ib(3).pared  byses1 female
	...
	1.pared_level "Parental Education, Reference=Some College", nolabel) ///
        label ///
         ...
         nobaselevels ///
               ...
               sfmt (2 0 0 0)               ///
               replace         
// Students who don’t plan to go to college score about 9.1 points lower on math tests 
