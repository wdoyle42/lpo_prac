...
`import excel`, well, imports . . . excel. Take a careful look at the excel worksheet before importing to understand which range should be imported.
    ...
    . import delimited "https://stats.idre.ucla.edu/wp-content/uploads/2016/02/hsb2
    > -2.csv", clear
    (11 vars, 200 obs)
...
For the rest of today's lecture, we'll use the `apipop` dataset, which is available online.

    . global urldata "https://stats.idre.ucla.edu/stat/stata/seminars/svy_stata_int
    > ro/apipop"
...
*Init: 15 August 2015; Updated: 18 September 2017*
