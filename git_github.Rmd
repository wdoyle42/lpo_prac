...
Git Kraken is graphical user interface to git. You'll need to download git kraken here: https://www.gitkraken.com/ . Once you have the program, open it up and then log in. Once logged in, go back to github.com and go to your repository, click on the link for clone or download, then copy the repo link. Go to gitkraken, then go to clone, and paste in the link. The files will then be loaded onto your computer. 
